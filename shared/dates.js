...
// Shared by the app and the server (D16); the app imports it through `app/src/lib/dates.js`.
 ...
 * @param {Date} [now] the moment to take the date of; defaults to now. The server's scheduler passes its clock.
